...
#$ -N without
#$ -o /proj/omics4tb2/alomana/scratch/messages.GBM.without.o.txt
#$ -e /proj/omics4tb2/alomana/scratch/messages.GBM.without.e.txt
#$ -pe smp 40
#$ -l hostname=baliga2
#$ -S /bin/bash
...
time cellranger aggr --id=without --csv=/proj/omics4tb2/alomana/projects/gbm/data/aggregation.without.csv --normalize=mapped --localcores=40 --localmem=90
echo "... run completed."
