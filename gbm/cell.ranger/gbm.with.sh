...
#$ -N with
#$ -o /proj/omics4tb2/alomana/scratch/messages.GBM.with.o.txt
#$ -e /proj/omics4tb2/alomana/scratch/messages.GBM.with.e.txt
#$ -pe smp 40
#$ -l hostname=baliga2
#$ -S /bin/bash
...
time cellranger aggr --id=with --csv=/proj/omics4tb2/alomana/projects/gbm/data/aggregation.with.csv --normalize=mapped --localcores=40 --localmem=90
echo "... run completed."
